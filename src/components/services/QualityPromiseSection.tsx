  ...
  const Feature = ({
    ...
    return (
      <div className="group relative">
        <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-soft hover:shadow-layered transition-all duration-300 hover:-translate-y-2 border border-gray-100 h-full">
