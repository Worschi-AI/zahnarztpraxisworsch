...
const LocationMap = () => {
  ...
  return <div className="md:w-1/2 animate-on-scroll">
      ...
      <div className="rounded-lg h-[400px] mb-6 overflow-hidden shadow-md">
        <iframe src={googleMapsEmbedUrl} width="100%" height="100%" style={{
        border: 0
      }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Zahnarztpraxis Worsch Dresden" className="rounded-lg"></iframe>
      </div>
