...
const AppointmentCTA = () => {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-dental-sage to-dental-sage-dark text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-2xl mx-auto animate-on-scroll">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-dental-sage hover:bg-dental-sand hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl">
              <Link to="/appointment">
            ...
            <PhoneButton
              size="lg"
              className="bg-white text-dental-sage hover:bg-dental-sand transition-all duration-300 shadow-lg hover:shadow-xl"
