...
const AppointmentCTA = () => {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-dental-turquoise to-dental-copper-light text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-2xl mx-auto animate-on-scroll">
          <h2 className="mb-4 text-xl md:text-2xl lg:text-3xl xl:text-4xl font-heading">Vereinbaren Sie jetzt ganz einfach Ihren persönlichen Beratungstermin beim Zahnarzt in Dresden-Laubegast!</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-dental-turquoise hover:bg-dental-beige hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl">
              <Link to="/appointment">
            ...
            <PhoneButton
              size="lg"
              className="bg-white text-dental-turquoise hover:bg-dental-beige transition-all duration-300 shadow-lg hover:shadow-xl"
