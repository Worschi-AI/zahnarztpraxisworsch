...
const HeroIntroSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-dental-white to-dental-beige/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 animate-on-scroll">
            <div className="mb-8">
              <h2 className="mb-8 text-dental-blue leading-tight">
              ...
              <p className="text-lg leading-relaxed text-dental-gray mb-8">
