...
const HeroIntroSection = () => {
  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-dental-cream to-dental-sand/30 relative overflow-hidden">
      {/* Dezente Eck-Dekorationen mit Animation */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-32 h-32 bg-dental-sage/10 rounded-full blur-[80px] animate-float"></div>
        <div className="absolute top-0 right-0 w-40 h-40 bg-dental-sand/15 rounded-full blur-[90px] animate-float animate-delay-300"></div>
        <div className="absolute bottom-0 left-0 w-36 h-36 bg-dental-sage/8 rounded-full blur-[85px] animate-float animate-delay-200"></div>
        <div className="absolute bottom-0 right-0 w-28 h-28 bg-dental-sand/12 rounded-full blur-[75px] animate-float animate-delay-400"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 animate-on-scroll">
            <div className="relative flex gap-4">
              ...
              <div className="relative flex-1">
                <div className="absolute -inset-2 bg-dental-sage/15 rounded-2xl blur-lg"></div>
              ...
              <div className="relative flex-1 mt-8">
                <div className="absolute -inset-2 bg-dental-sand/15 rounded-2xl blur-lg"></div>
                <div className="relative rounded-2xl overflow-hidden shadow-layered border-4 border-white">
                  <img 
          ...
          <div className="lg:w-1/2 animate-on-scroll">
            <div className="mb-6 lg:mb-8">
              <h2 className="mb-6 lg:mb-8 text-dental-olive-gray leading-tight text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold font-heading">
                Herzlich willkommen bei Ihrem Zahnarzt in Dresden-Laubegast!
              </h2>
              
              <p className="text-base lg:text-lg leading-relaxed text-dental-olive-gray mb-6">
              ...
              <p className="text-base lg:text-lg leading-relaxed text-dental-olive-gray mb-8">
            ...
            <div className="mt-8 lg:mt-10">
              <Button asChild size="lg" className="bg-dental-sage hover:bg-dental-sand hover:scale-105 transform transition-all duration-300 px-8 py-3">
                <Link to="/about">
