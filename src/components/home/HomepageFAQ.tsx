            ...
            <div className="animate-on-scroll">
              <Accordion type="single" collapsible className="w-full space-y-4">
                <AccordionItem value="item-1" className="border-b border-gray-200 pb-4">
                  <AccordionTrigger className="py-4 text-left text-dental-gray hover:text-dental-blue text-lg font-medium">
                    Was macht die Zahnarztpraxis Worsch in Dresden besonders für junge Patienten und ästhetische Wünsche?
                  </AccordionTrigger>
                  <AccordionContent className="pt-2 text-dental-gray text-base leading-relaxed">
